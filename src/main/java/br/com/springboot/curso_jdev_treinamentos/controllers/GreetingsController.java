...
public class GreetingsController {
    ...
    public String greetingText(@PathVariable String name) {
        return "Bem vindo ao Curso Spring Boot API: " + name + "!";
    }
    ...
    /*Metodo que lista todos os usuarios do banco de dados*/
    @GetMapping(value = "listatodos")
    @ResponseBody
    public ResponseEntity<List<Usuario>> listaUsuario(){
    	
    	List<Usuario> usuarios = usuarioRepository.findAll(); /*Busca todos os ususarios no banco de dados*/
